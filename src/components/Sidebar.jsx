  ...
  return (
    <> 
        <nav className=' h-screen flex flex-col bg-secondary  shadow-sm'>
          ...
          <Image src="https://ui-avatars.com/api/?background=0D8ABC&color=fff" width={50} height={50} className="w-10 h-10 rounded-md" alt="pic" />
          <div className={`flex justify-between items-center overflow-hidden transition-all ${open ?"w-0 ":"w-52 ml-3"}`}>
